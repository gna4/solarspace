...
<h1 style="font-weight:normal;">
    Ваш заказ на сумму <?= Yii::t('OrderModule.order', '{n} гривна|{n} гривны|{n} гривен', [$order->getTotalPrice()]);?> в магазине "<?= Yii::app()->getModule('yupe')->siteName;?>".
</h1>
...
<table cellpadding="6" cellspacing="0" style="border-collapse: collapse;">
    ...
    <?php foreach ($order->products as $orderProduct): ?>
        ...
        <tr>
            ...
            <td align=right
                ...
                <?= $orderProduct->quantity; ?> шт. &times; <?= $orderProduct->price; ?>&nbsp; грн.
            </td>
        </tr>
    <?php endforeach; ?>
    ...
    <?php if ($order->hasCoupons()): ?>
        <tr>
            ...
            <td align=right
                ...
                &minus;<?= $order->coupon_discount; ?>&nbsp;грн.
            </td>
        </tr>
    <?php endif; ?>
    ...
    <tr>
        ...
        <td align="right"
            ...
            <?= $order->getTotalPriceWithDelivery(); ?>&nbsp;грн.
        </td>
    </tr>
</table>
